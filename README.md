A small project using TheMealDB API (https://www.themealdb.com/). You can search dishes by keywords and load full information about any single meal from search results or even load information about a random dish. 
